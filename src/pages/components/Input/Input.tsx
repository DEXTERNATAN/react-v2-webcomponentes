...
const Input: React.FC = () => {
  return (
    <div className="input-container" role="main" style={{ padding: "20px" }}>
      <h1>Input</h1>
      <p>
        Esta página apresenta variações e usos do componente{" "}
        <code>&lt;br-input&gt;</code>, que permite representar usuários por
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="input-group">
            <BrInput text="OK" density="medium" title="Habilitado" />
            <BrInput
              text="OK"
              density="medium"
              disabled
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="input-group">
            <BrInput isIconic density="large" title="Padrão" />
            <BrInput
              isIconic
              density="large"
              iconWidth="32px"
