  ...
  return (
    <div className="switch-container" role="main" style={{ padding: "20px" }}>
      ...
      <p>
        ...
        <code>&lt;br-switch&gt;</code>, que permite representar usuários por
      ...
      >
        ...
        <div className="card-content">
          ...
          <div
            ...
            role="group"
            aria-label="Switches principais"
          >
            <BrSwitch
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="switch-group">
            <BrSwitch text="OK" density="medium" title="Habilitado" />
            <BrSwitch
              text="OK"
              density="medium"
              disabled
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="switch-group">
            <BrSwitch isIconic density="large" title="Padrão" />
            <BrSwitch
              isIconic
              density="large"
              iconWidth="32px"
