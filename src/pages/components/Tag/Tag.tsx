  ...
  return (
    <div className="tag-container" role="main" style={{ padding: "20px" }}>
      ...
      <p>
        ...
        <code>&lt;br-tag&gt;</code>, que permite representar usuários por
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="tag-group">
            <BrTag text="OK" density="medium" title="Habilitado" />
            <BrTag
              text="OK"
              density="medium"
              disabled
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="tag-group">
            <BrTag isIconic density="large" title="Padrão" />
            <BrTag
              isIconic
              density="large"
              iconWidth="32px"
