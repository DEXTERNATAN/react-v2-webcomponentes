  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <code>&lt;br-formulario&gt;</code>, que permite representar usuários por
      ...
      <section
        aria-labelledby="tipo-formulario"
      ...
      >
        ...
        <div className="card-content">
          ...
          <div
            className="formulario-group"
            role="group"
            aria-label="Formularioes principais"
          >
            <BrFormulario
              ...
              aria-label="Formulario tipo imagem"
            />
            <BrFormulario
              isIconic
              density="medium"
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="formulario-group">
            <BrFormulario text="OK" density="medium" title="Habilitado" />
            <BrFormulario
              text="OK"
              density="medium"
              disabled
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="formulario-group">
            <BrFormulario isIconic density="large" title="Padrão" />
            <BrFormulario
              isIconic
              density="large"
              iconWidth="32px"
