import { BrItem, BrMessage } from "@govbr-ds/webcomponents-react";
  ...
  return (
    <div className="item-container" role="main" style={{ padding: "20px" }}>
      ...
      <p>
        ...
        <code>&lt;br-item&gt;</code>, que permite representar usuários por
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="item-group">
            <BrItem text="OK" density="medium" title="Habilitado" />
            <BrItem
              text="OK"
              density="medium"
              disabled
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="item-group">
            <BrItem isIconic density="large" title="Padrão" />
            <BrItem
              isIconic
              density="large"
              iconWidth="32px"
