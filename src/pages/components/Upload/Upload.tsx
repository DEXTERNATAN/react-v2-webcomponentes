  ...
  return (
    <div className="upload-container" role="main" style={{ padding: "20px" }}>
      ...
      <p>
        ...
        <code>&lt;br-upload&gt;</code>, que permite representar usuários por
      ...
      >
        ...
        <div className="card-content">
          ...
          <div
            ...
            role="group"
            aria-label="Uploades principais"
          >
            <BrUpload
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="upload-group">
            <BrUpload text="OK" density="medium" title="Habilitado" />
            <BrUpload
              text="OK"
              density="medium"
              disabled
      ...
      <div className="br-card screen-preview mb-4">
        ...
        <div className="card-content">
          ...
          <div className="upload-group">
            <BrUpload isIconic density="large" title="Padrão" />
            <BrUpload
              isIconic
              density="large"
              iconWidth="32px"
